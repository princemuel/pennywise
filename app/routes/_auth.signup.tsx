    ...
    >
      ...
      <section className="grid grid-cols-6 gap-5">
        ...
        <div className="group col-span-full flex flex-col gap-2">
          <label htmlFor={fields.name.id} className="text-xs font-bold text-grey-500">
            Name
          </label>
          <input
            ...
            autoComplete="name"
          />
          <span id={fields.name.errorId} className="self-end text-xs text-red-400">
            {fields.name.errors}
          </span>
        </div>
      ...
      <footer className="flex items-center justify-center gap-4">
        ...
        <Link to="/signin" className="font-bold text-grey-900 underline" viewTransition>
          Sign in
        </Link>
      </footer>
    </Form>
